...
public class Ease {
	...
	// Easing constants.
	/** @private */ private static double PI= Math.PI;
	/** @private */ private static double PI2 = Math.PI / 2;
	/** @private */ @SuppressWarnings("unused")	private static double EL = 2 * PI / .45;
	/** @private */ private static double B1 = 1 / 2.75;
	/** @private */ private static double B2 = 2 / 2.75;
	/** @private */ private static double B3 = 1.5 / 2.75;
	/** @private */ private static double B4 = 2.5 / 2.75;
