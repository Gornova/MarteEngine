	...
	public void update(GameContainer container, int delta) throws SlickException {
		...
		if (player != null) {
			...
			if (normalPlayerSpeed == null) {
				// store the player speed and give him half the amount to slow him down
				normalPlayerSpeed = new Vector2f(angel.maxSpeed);
				slowPlayerSpeed = new Vector2f(angel.maxSpeed.x *0.5f, angel.maxSpeed.y * 2.0f);
			...
			if (normalPlayerSpeed != null) {
				...
				if (angel != null) {
					angel.maxSpeed = new Vector2f(Globals.originalPlayerMaxSpeed);
