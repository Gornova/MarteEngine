...
public class PhysicsEntity extends Entity {
	...
	public static Vector2f nullSpeed = new Vector2f(0, 0);
	...
	public void update(GameContainer container, int delta)
		...
		// update possible animation stuff but reset speed to 0,0 because
		// physics entities deal with speed on their own
		Vector2f originalSpeed = speed;
		speed = nullSpeed;
	...
	public void motion(boolean moveX, boolean moveY) {
		...
		if (moveX) {
			...
			if (!motionx(this, speed.x) && stopOnCollision) {
				speed.x = 0;
			}
		...
		if (moveY) {
			// make us move, and stop us on collision
			if (!motiony(this, speed.y) && stopOnCollision) {
				speed.y = 0;
			}
